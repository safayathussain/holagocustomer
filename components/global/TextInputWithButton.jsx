...
const TextInputWithButton = ({ disableBtn=false,label, id, name, type = 'text', className, placeholder, buttonText = '', buttonClass='', rounded='xl', ...etc }) => {
    return (
        <div>
            <div>
                ...
                <div className="mt-0.5 flex items-center">
                    <input
                        ...
                        {...etc}
                    />
                    <button disabled={disableBtn} className={`border border-l-0 rounded-${rounded} p-2.5 rounded-l-none text-sm ${buttonClass}`}>
                        {buttonText}
                    </button>
                </div>
            </div>
